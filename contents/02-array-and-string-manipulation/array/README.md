...
14. **Task: Find Intersection of Two Arrays**
...
28. **Task: Implement Stack using Queues**
...
22. **Task: Implement Queue using Stacks**
    - Implement a queue using two stacks.
...
49. **Task: First Missing Positive**
   - **Input:** `[3, 4, -1, 1]`
